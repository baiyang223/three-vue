...
onMounted(() => {
  ...
  camera.value.position.set(1.5, 1, 1.5)
  ...
  const bgTexture = loader.load(new URL('../assets/textures/050.jpg', import.meta.url).href)
  ...
  gltfLoader.load(new URL('../assets/model/bear.gltf', import.meta.url).href, (gltf: any) => {
